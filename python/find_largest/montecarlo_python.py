...
from hand_evaluator import eval_best_hand
...
class MonteCarlo(object):
    ...
    def distribute_cards_to_players(self, deck, player_amount, player_card_list, known_table_cards,
        ...
        # Welson remark: ****it's important to simulate opponent's cards.
    ...
    def run_montecarlo(self, original_player_card_list, original_table_card_list, player_amount, ui, maxRuns,
        ...
        if ghost_cards != '':
            OriginalDeck.pop(OriginalDeck.index(ghost_cards[0])) #w: rid off ghost_cards
        ...
        for m in range(maxRuns):
            ...
            # welson remark:不停的模拟对手的手牌，同时从DECK中去除hand_card, board_card, oppo_hand_card.
            ...
            # w: winnerCardType = score, card_ranks, hand_type
            ...
            CollusionPlayers = 0
            if winner < CollusionPlayers + 1: #winner is myself
                wins += 1
...
if __name__ == '__main__':
    Simulation = MonteCarlo()
    log = logging.getLogger('Monte Carlo main')
